...
#+BEGIN_SRC emacs-lisp
  (use-package powerline
    ...
    :custom-face
    (powerline-active0 ((t (:background "color-48" :foreground "black"))))
    (powerline-inactive0 ((t (:background "black" :foreground "#D8DEE9"))))
    (powerline-inactive1 ((t (:background "brightblack" :foreground "#D8DEE9"))))
    (powerline-inactive2 ((t (:background "brightblack" :foreground "#D8DEE9")))))
#+end_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-foreground 'line-number-current-line  "cyan")
#+END_SRC

** change customization menu color
...
#+BEGIN_SRC emacs-lisp
  (use-package ycmd
    ...
    (set-variable 'ycmd-server-command
                  `("python3" "-u" ,(file-truename "~/Matt_Installed_package/ycmd/ycmd"))))
