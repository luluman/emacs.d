...
#+BEGIN_SRC emacs-lisp
  (defun MattLu/color-config ()
    ...
    (set-face-attribute 'font-lock-doc-face nil
                        :foreground "color-243")
    (set-face-foreground 'org-drawer "color-243")
...
#+begin_src emacs-lisp
  ...
  (defun powerline-minor-modes-modify (orig-fun &rest args)
    ...
    (defvar MattLu/default-mode-alist minor-mode-alist)
    (let ((minor-mode-alist
           (list `(:propertize ("" (:eval (--filter (memq (car it) MattLu/minor-mode-direct)
...
#+BEGIN_SRC emacs-lisp
  (use-package eglot
    ...
    :hook
    ((c-mode c++-mode python-mode sh-mode)
     . eglot-ensure))
#+END_SRC

#+BEGIN_SRC emacs-lisp
  ;; (defun MattLu/eglot-helper (orig-fun &rest args)
  ;;   (message "display-buffer called with args %S" args)
  ;;   (let ((res (apply orig-fun args)))
  ;;     (message "display-buffer returned %S" res)
  ;;     res))

  ;; (advice-add 'eglot--lsp-xref-helper :around #'MattLu/eglot-helper)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package ivy-xref
    ...
    (bind-keys* ("M-," . xref-pop-marker-stack))
    :init
...
#+BEGIN_SRC emacs-lisp
  (use-package org-bullets
    :config
    (MattLu/change-cdr-value org-bullets--keywords :foreground '("black"))
...
#+BEGIN_SRC emacs-lisp
  (use-package ivy-rich
    ...
    :config
    (plist-put
     (plist-get ivy-rich-display-transformers-list
                'ivy-switch-buffer)
