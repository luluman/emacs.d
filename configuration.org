...
** mct + marginalia + ctrlf + consult

Minibuffer and Completions in Tandem, also known as “MCT”, “Mct”, mct, or
mct.el, is a package that enhances the default minibuffer and *Completions* buffer
of Emacs 27 (or higher) so that they work together as part of a unified
framework.
