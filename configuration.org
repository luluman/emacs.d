...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "u" (my/define-embark-gpt-refactor gptel--openrouter ~anthropic/claude-fable-latest)
      "y" (my/define-embark-gpt-refactor gptel--openrouter ~openai/gpt-latest)
      ...
      "o" (my/define-embark-gpt-refactor gptel--anthropic claude-opus-4-8 "")
