    ...
    (setq gptel--openai
          (gptel-make-openai "CC"
            ...
            '((kimi-k3 :request-params (:reasoning_effort "high"))
              (qwen3.8-max :request-params (:reasoning_effort "high"))
    ...
    (defvar gptel--openrouter
      (gptel-make-openai "OpenRouter"
        ...
        '((openai/gpt-6-astra-pro :request-params (:reasoning (:effort "xhigh")))
          ...
          (~anthropic/claude-fable-latest :request-params (:reasoning (:effort "xhigh")))
...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "q" (my/define-embark-gpt-refactor gptel--openai qwen3.8-max "")
