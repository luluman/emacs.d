...
#+begin_src emacs-lisp
  (use-package projectile
    ...
    :config
    ;; Some local variables of projectile are not marked as saft by default.
    ...
    ;; (put 'leo-special-var 'safe-local-variable (lambda (_) t)) ;; all values
...
#+BEGIN_SRC emacs-lisp
  (use-package flyspell
    ...
    (setq ispell-dictionary "en_US"
          ...
          ispell-extra-args '("--camel-case" "--sug-mode=ultra" "--run-together" "--run-together-limit=16")
...
#+begin_src emacs-lisp
  ...
  (use-package fussy
    ...
    (completion-styles '(fussy orderless basic))
...
#+begin_src emacs-lisp
  (use-package flymake-popon
    :custom-face
    (flymake-popon ((t (:inherit default :background "black"))))
    :hook
