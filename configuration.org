...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "o" (my/define-embark-gpt-refactor gptel--openrouter anthropic/claude-opus-4.5)
      "s" (my/define-embark-gpt-refactor gptel--openrouter anthropic/claude-sonnet-4.5)
      "i" (my/define-embark-gpt-refactor gptel--anthropic claude-opus-4-5-20251101 "")
      "a" (my/define-embark-gpt-refactor gptel--anthropic claude-sonnet-4-5-20250929 "")
