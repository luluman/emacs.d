...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    (set-face-attribute 'company-preview-common
...
#+BEGIN_SRC emacs-lisp
  (use-package ivy
    ...
    ;; set face for terminal
    (set-face-attribute 'isearch
                        t :background "brightcyan" :foreground "black")
    (set-face-attribute 'ivy-minibuffer-match-face-1
                        t :background "green" :foreground "black")
    (set-face-attribute 'ivy-minibuffer-match-face-2
                        t :background "yellow" :foreground "black" :weight 'bold)
    (set-face-attribute 'ivy-minibuffer-match-face-3
                        t :background "cyan" :foreground "black" :weight 'bold)
    (set-face-attribute 'ivy-minibuffer-match-face-4
