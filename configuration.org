...
#+begin_src emacs-lisp
  ...
  (setq MattLu/remote-host-name "EVB")
  ...
  (defun MattLu/new-socks5-proxy ()
    (apply #'start-process "socks5-proxy"
           ...
           "ssh" (list "-ND" centaur-socks-proxy MattLu/remote-host-name)))
...
#+begin_src emacs-lisp
  (use-package mind-wave
    ...
    :load-path "~/.emacs.d/mind-wave"
    :custom
    (mind-wave-api-key-path (expand-file-name "~/.ssh/chatgpt_api_key")))
#+end_src
