  ...
  (use-package gptel
    ...
    (setq gptel--openai
          (gptel-make-openai "CC"
            ...
            :stream t
            :models
            '((kimi-k2.7-code :request-params (:reasoning_effort "high"))
              (glm-5.2 :request-params (:reasoning_effort "high"))
              (deepseek-v4-pro :request-params (:reasoning_effort "max"))
              (gemini-3.5-flash :request-params (:reasoning_effort "high"))
...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "o" (my/define-embark-gpt-refactor gptel--openai claude-opus-4-8-thinking)
      ...
      "u" (my/define-embark-gpt-refactor gptel--openrouter ~anthropic/claude-opus-latest)
      "c" (my/define-embark-gpt-refactor gptel--openrouter ~openai/gpt-latest)
