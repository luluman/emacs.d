...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-openrouter-model-map
      ...
      "p" (my/define-embark-gpt-refactor gptel--openrouter openai/gpt-5.1)
      "c" (my/define-embark-gpt-refactor gptel--openrouter openai/gpt-5-codex)
      "v" (my/define-embark-gpt-refactor gptel--openrouter openai/gpt-5.1-codex)
...
#+begin_src emacs-lisp
  (use-package corfu
    ...
    ;; Explicitly hide the Corfu popup after quitting, as it can occasionally linger when switching buffers.
    (advice-add 'corfu-quit :after (lambda () (corfu--popup-hide)))
    ...
    :hook
    (window-selection-change-functions . corfu--window-change)
    (window-buffer-change-functions . corfu--window-change))
