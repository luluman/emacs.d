  ...
  (use-package gptel
    ...
    (defvar gptel--anthropic
      (gptel-make-anthropic "Claude"
        ...
        :request-params '(:max_tokens 64000 :thinking (:type "adaptive") :output_config (:effort "high"))))
...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "a" (my/define-embark-gpt-refactor gptel--openrouter anthropic/claude-sonnet-4.6)
      "o" (my/define-embark-gpt-refactor gptel--anthropic claude-opus-4-6 "")
      "s" (my/define-embark-gpt-refactor gptel--anthropic claude-sonnet-4-6 "")
      "p" (my/define-embark-gpt-refactor gptel--openai--cc gpt-5.4 "")
      "g" (my/define-embark-gpt-refactor gptel--gemini gemini-3.1-pro-preview)
      "z" (my/define-embark-gpt-refactor gptel--openrouter z-ai/glm-5.1)
