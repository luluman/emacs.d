...
#+begin_src emacs-lisp
  ...
  (setq MattLu/socks-proxy "127.0.0.1:7891")    ; SOCKS proxy
  ...
  (defun MattLu/themes-toggle ()
    ...
    (let* ((current-theme (car custom-enabled-themes))
      ...
      (if index
        ...
        (setq MattLu/choosing-theme (car theme-pool)))
...
#+begin_src emacs-lisp
  (use-package gptel
    ...
    (setq-default gptel-model "gemini-1.5-pro-latest" ;Pick your default model
