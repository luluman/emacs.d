...
#+begin_src emacs-lisp
  (use-package tree-sitter
    :load-path "~/.emacs.d/emacs-tree-sitter/lisp")
  ...
  (use-package tree-sitter-langs
    :load-path "~/.emacs.d/emacs-tree-sitter/langs")
...
#+begin_src emacs-lisp
  (use-package back-button
    :bind (:map back-button-mode-map
                ("C-c C-<right>" . hydra-back-and-forth/back-button-local-forward)
                ("C-c C-<left>" . hydra-back-and-forth/back-button-local-backward)
                ("C-c C-<up>" . hydra-back-and-forth/back-button-global-backward)
                ("C-c C-<down>" . hydra-back-and-forth/back-button-global-backward))
    :init
    (back-button-mode 1)
    (setq back-button-mode-map (make-sparse-keymap))
    :config
