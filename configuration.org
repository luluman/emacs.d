...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    :custom-face
    (company-echo-common ((t (:background "brightblack"))))
    (company-preview-common ((t (:background "#1a4b77"))))
    (company-tooltip ((t (:background "black" :foreground "white"))))
    (company-scrollbar-bg ((t (:background "brightblack" :foreground "brightblack"))))
    (company-scrollbar-fg ((t (:background "cyan" :foreground "cyan"))))
    (company-tooltip-common-selection ((t (:background "brightcyan" :foreground "black"))))
