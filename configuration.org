...
easier-to-type =C-c s= to useful searches.
...
#+BEGIN_SRC emacs-lisp
  (use-package ycmd
    :if (MattLu/YCMD-get-path MattLu/YCMD-path)
...
*** COMMENT grammatical-edit

#+BEGIN_SRC emacs-lisp
  (use-package grammatical-edit
    :load-path "~/.emacs.d/grammatical-edit"
    ...
    :bind (:map grammatical-edit-mode-map
                ...
                ("DEL" . grammatical-edit-backward-delete)
