...
#+BEGIN_SRC emacs-lisp
  (setq frame-title-format
        '(""
          "%b"
          (:eval
           (let ((project-name (wg-mode-line-string)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-)") 'MattLu/reset-font-size)
  (global-set-key (kbd "C-+") 'MattLu/increase-font-size)
  (global-set-key (kbd "C-_") 'MattLu/decrease-font-size)
