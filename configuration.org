    ...
    (setq gptel--openai
          (gptel-make-openai "CC"
            ...
            '((kimi-k3 :request-params (:reasoning_effort "high"))
              ...
              (glm-5.2 :request-params (:reasoning_effort "high"))
              (deepseek-v4-pro :request-params (:reasoning_effort "max"))
              (deepseek-v4-flash-0731 :request-params (:reasoning_effort "high"))
...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "z" (my/define-embark-gpt-refactor gptel--openai glm-5.2 "")
      "d" (my/define-embark-gpt-refactor gptel--openai deepseek-v4-pro "")
      ...
      "K" (my/define-embark-gpt-refactor gptel--openai ~moonshotai/kimi-latest)
      ...
      "D" (my/define-embark-gpt-refactor gptel--tenstorrent deepseek-ai/DeepSeek-R1-0528))
