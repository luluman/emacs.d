...
#+begin_src emacs-lisp
  (use-package indent-bars
    :load-path "~/.emacs.d/third_party/indent-bars"
    :config
...
#+begin_src emacs-lisp
  (defun my/quit-all ()
    ...
    (if (eq last-command 'my/quit-all)
      ...
      (when (bound-and-true-p ts-movement-mode) (tsm/clear-overlays (point)))
      (keyboard-quit)
      ))
...
#+begin_src emacs-lisp
  (use-package ts-movement
    ...
    :bind (:map ts-movement-map
                ("C-M-f" . tsm/node-next)
                ("C-M-b" . tsm/node-prev)
                ("C-M-u" . tsm/node-parent)
                ("C-M-d" . tsm/node-child)
                ("C-M-m" . tsm/node-mark)
                ("M-C" . (lambda ()
                           (interactive)
                           (symbol-overlay-remove-all)
                           (tsm/clear-overlays (point))))
                ("C-c ." . tsm/hydra/body))
