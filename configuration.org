    ...
    (let* ((current-theme (car custom-enabled-themes))
      ...
      (if index
          (progn
            ...
            (load-theme (nth (% (+ 1 index) (length theme-pool))
                             theme-pool) t))
        (disable-theme current-theme)
        (load-theme (nth 0 theme-pool) t))))
#+end_src
...
*** COMMENT modus-operandi theme
"light side"

#+begin_src emacs-lisp
  (defun MattLu/apply-modus-operandi-theme ()
    "Apply my chosen theme"
    (interactive)
...
#+begin_src emacs-lisp
  (use-package modus-operandi-theme
    ...
    (if (daemonp)
        (add-hook 'after-make-frame-functions
                  (lambda (frame)
                    (with-selected-frame frame (MattLu/apply-modus-operandi-theme))))
      (MattLu/apply-modus-operandi-theme)))
#+end_src

*** COMMENT modus-vivendi theme
"dark side"

#+begin_src emacs-lisp
  (defun MattLu/apply-modus-vivendi-theme ()
    "Apply my chosen theme"
    (interactive)
...
#+begin_src emacs-lisp
  (use-package modus-vivendi-theme
    ...
    (if (daemonp)
        (add-hook 'after-make-frame-functions
                  (lambda (frame)
                    (with-selected-frame frame (MattLu/apply-modus-vivendi-theme))))
      (MattLu/apply-modus-vivendi-theme)))
#+end_src
