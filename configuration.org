...
#+begin_src emacs-lisp
  (use-package ghostel
    ...
    (defun my/ghostel ()
      "Open Ghostel, then switch to line mode after the prompt renders."
      (interactive)
      (let ((ghostel-buffer (ghostel t)))
        ;; Switching to line mode synchronously would race with prompt
        ;; rendering, so defer briefly to let Ghostel draw the shell prompt.
        (run-at-time 0.1 nil
                     (lambda (buffer)
                       (with-current-buffer buffer
                         (ghostel-line-mode)
  ...
  (use-package gptel
    ...
    (setq gptel--openai
          (gptel-make-openai "CC"
            ...
            '((kimi-k2.7-code :request-params (:reasoning_effort "high"))
              ...
              (gpt-5.5 :request-params (:reasoning_effort "xhigh"))
    ...
    (defvar gptel--openrouter
      (gptel-make-openai "OpenRouter"
        ...
        :request-params '(:reasoning (:enabled t :effort "xhigh"))))
...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "s" (my/define-embark-gpt-refactor gptel--openrouter ~anthropic/claude-sonnet-latest)
      "p" (my/define-embark-gpt-refactor gptel--openai gpt-5.5)
      "k" (my/define-embark-gpt-refactor gptel--openai kimi-k2.7-code)
      "g" (my/define-embark-gpt-refactor gptel--openrouter ~google/gemini-pro-latest)
      "f" (my/define-embark-gpt-refactor gptel--openrouter ~google/gemini-flash-latest)
