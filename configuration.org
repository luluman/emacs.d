...
#+BEGIN_SRC emacs-lisp
  (setq org-ellipsis " …")
  (set-face-foreground 'org-ellipsis  "color-50")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        '(("C" "Misc" entry (file "~/.Org/inbox.org")
           "* TODO %a\n  :PROPERTIES:\n  :CAPTURED: %U\n  :END:\n"
           :prepend t :immediate-finish t)

          ("c" "Misc (edit)" entry (file "~/.Org/inbox.org")
           "* TODO %?\n  :PROPERTIES:\n  :CAPTURED: %U\n  :END:\n\n- %a" :prepend t)
...
#+BEGIN_SRC emacs-lisp
  (setq org-refile-targets '((org-agenda-files . (:maxlevel . 6))
                             ((org-file-path "libre.org") . (:maxlevel . 1))))
  ...
  (setq org-agenda-custom-commands
        `(
          ...
          ("#" "DONE/CANCELED/DELEGATED"
           ...
           ((org-agenda-files (org-file-path '("gtd.org" "rdv.org" "matt.org" "libre.org")))
            (org-agenda-sorting-strategy '(timestamp-up))))

          ("" . "Task and rendez-vous for today")
          ("" "Travail (tout)" agenda "Tasks and rdv for today"
           ((org-agenda-span 1)
            (org-agenda-files (org-file-path '("gtd.org" "rdv.org" "matt.org")))
            (org-deadline-warning-days 3)
            (org-agenda-sorting-strategy
             '(todo-state-up time-up priority-down))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-files (org-file-path '("agenda.org" "gtd.org")))
