  ...
  (use-package gptel
    ...
    (defvar gptel--anthropic
      (gptel-make-anthropic "Claude"
        ...
        :request-params '(:max_tokens 64000 :thinking (:type "adaptive") :output_config (:effort "xhigh"))))
...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "i" (my/define-embark-gpt-refactor gptel--openrouter anthropic/claude-opus-4.7)
