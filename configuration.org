...
#+BEGIN_SRC emacs-lisp
  (use-package git-gutter
    ...
    :config
    (defmacro +change-face (var color)
      `(set-face-attribute ,var nil
                           :foreground ,color
                           :background (face-background 'default)))
    (+change-face 'git-gutter:added "green")
    (+change-face 'git-gutter:deleted "red")
    (+change-face 'git-gutter:modified "yellow")
    ;; :hook
    ;; (git-gutter-mode
    ;; . (lambda ()
