...
#+begin_src emacs-lisp
  (use-package embark
    ...
    (defvar-keymap gptel-model-map
      ...
      "o" (my/define-embark-gpt-refactor gptel--openrouter openai/gpt-5.2)
      "p" (my/define-embark-gpt-refactor gptel--openrouter anthropic/claude-opus-4.5)
      "c" (my/define-embark-gpt-refactor gptel--openrouter openai/gpt-5.1-codex-max)
      "s" (my/define-embark-gpt-refactor gptel--openrouter anthropic/claude-sonnet-4.5)
      "g" (my/define-embark-gpt-refactor gptel--gemini gemini-3-pro-preview)
      "f" (my/define-embark-gpt-refactor gptel--gemini gemini-3-flash-preview)
      "r" (my/define-embark-gpt-refactor gptel--deepseek deepseek-reasoner)
      "d" (my/define-embark-gpt-refactor gptel--deepseek-speciale deepseek-reasoner))
