...
#+BEGIN_SRC emacs-lisp
  (defun MattLu/apply-powerline ()
    ...
    (set-face-attribute 'mode-line nil :background "brightgreen" :foreground "black"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    (set-face-attribute 'company-echo-common t :background "brightblack")
    (set-face-attribute 'company-preview-common t :background "#1a4b77")
    (set-face-attribute 'company-template-field t :background "cyan" :foreground "black")
    (set-face-attribute 'company-tooltip t :background "black" :foreground "white")
    (set-face-attribute 'company-preview-search
                        t :background "brightcyan" :foreground "black")
    (set-face-attribute 'company-scrollbar-bg
                        t :background "brightblack" :foreground "brightblack")
    (set-face-attribute 'company-scrollbar-fg t :background "cyan" :foreground "cyan")

    (set-face-attribute 'company-tooltip-common-selection
                        t :background "brightcyan" :foreground "black")
    (set-face-attribute 'company-tooltip-selection
                        t :background "brightcyan" :foreground "black" :weight bold))
#+END_SRC
...
** COMMENT Use =smex= to handle =M-x= with =ido=
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; globally enable fuzzy matching for helm-mode
    ...
    ;; (setq helm-candidate-number-limit 50) ; for faster fuzzy matching
    (setq helm-recentf-fuzzy-match t)
    (setq helm-buffers-fuzzy-matching t)
    (setq helm-M-x-fuzzy-match t)        ;; M-x fuzzy matching
...
#+BEGIN_SRC emacs-lisp
  (use-package avy
    ...
    :config
    (setq avy-all-windows t)) ;; jump in current frame
#+END_SRC
